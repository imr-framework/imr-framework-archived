'''
This is the code to implement Unet for training radial k-space image with ground truth image.
...
def new_deconv_layer(input,  # The previous layer.
                     ...
                     filter_size,
                     img_size,# Width and height of each filter. (5x5)
...
soptimizer=tf.train.GradientDescentOptimizer(learning_rate=0.0001).minimize(cost)
